...
_project_cmd() {
  ...
  if [ -f "$command_file" ]; then
    ...
    echo "  docker compose_update Updated the docker compose file for this project by rendering the template from \$PROJECT_DOCKER_COMPOSE_TEMPLATE. See docker section in .env for more details."
    ...
    echo "  docker_images_build   Builds one ore more docker images located in a common base path."
